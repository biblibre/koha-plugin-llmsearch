...
# Test that chat.js and chat.css can be read
...
# Test that API routes contain expected endpoints
...
# Test template file can be loaded
...
# Test that the plugin inherits from Koha::Plugins::Base
isa_ok($plugin, 'Koha::Plugins::Base', 'Plugin inherits from Koha::Plugins::Base');

# Test that all required base methods exist
can_ok($plugin, qw(
    new
    get_template
    output_html
